...
export const CssStore: Scripts[] = [
  ...
  { name: 'leaflet-css', type: 'css', src: 'assets/css/leaflet.min.css' },
  { name: 'youtube-css', type: 'css', src: 'assets/css/youtube.min.css' },
  ...
  { name: 'leaflet-js', type: 'js', src: 'assets/js/leaflet.js' },
  { name: 'OSMLocationPicker', type: 'js', src: 'assets/js/OSMLocationPicker.js' },
  { name: 'youtube-jquery', type: 'js', src: 'assets/js/youtube-jquery.js' },
  { name: 'youtube-js', type: 'js', src: 'assets/js/youtube-script.min.js' }
];
